...
% Previous work \cite{ahmednacer:inria-00629503,lseq2017} has demonstrated the relevance of Sequence \acp{CRDT} to address privacy and resilience to censorship concerns, notably thanks to their compatibility with peer-to-peer approaches.
% As a result, several collaborative editors using \acp{CRDT} were proposed \cite{}.
...
In order to measure the introduced overhead, we proceeded to benchmarks.

...
\mnnote{
    TODO: Rédiger paragraphe introduisant l'approche de la réplication optimiste et de l'eventual consistency pour construire des systèmes distribués disponibles même en cas de partition réseaux.
    Préciser que requiert un mécanisme de gestion de conflits pour supporter les modifications concurrentes.
}

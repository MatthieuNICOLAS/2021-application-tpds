...
This deferment reduces the likelihood of nodes performing unnecessary work.
...
However, this overhead is negligible (hundreds of microseconds per identifier according to \Cref{fig:evolution-integration-time-remote-insert}) compared to the cost of an unnecessary rename of the whole state (hundreds of milliseconds to seconds according to \Cref{tab:evolution-integration-time-rename}).

\mnnote{TODO: Indiquer que besoin de pouvoir redo les opérations}

...
Section \ref{sec:evaluation} presents the experimental evaluation of Renamable to which we proceeded and the obtained results.
...
The second one \cite{5158449,WeissICDCS09,weiss:hal-00450416,AndreCollaborateCom2013,lseq2013,lseq2017} avoids the need of tombstones by attaching identifiers from a dense totally ordered set to elements.

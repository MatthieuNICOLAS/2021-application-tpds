...
To address these issues, previous work\cite{letia:hal-01248270,zawirski:hal-01248197} has proposed limiting the number of nodes participating in the consensus protocol.
To do so, \cite{letia:hal-01248270,zawirski:hal-01248197} assign this task to a selected small set of stable and well-connected nodes.
On the contrary, our goal is to design a solution suited to distributed systems with equal nodes in terms of rights and duties.
We thus choose to handle concurrent \emph{rename} operations and present below a corresponding coordination-free conflict resolution mechanism.

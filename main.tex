...
\mnnote{TODO: Ajouter et présenter figure sur l'\emph{epoch tree} et la relation \emph{priority} correspondant à l'exemple de la figure \autoref{fig:conflicting-rename-operations}}

...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\columnwidth]{img/snapshot-sizes-alt-legende-v2.png}
...
Experiments show that the renaming mechanism itself may temporary increase the metadata of the data structure, notably in case of concurrent \emph{rename} operations.

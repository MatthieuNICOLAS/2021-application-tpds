...
\textsc{renameBlock} would reduce the integration times of \emph{rename} operations, since its time complexity would no longer depend on the number of identifiers (\ie the number of elements) but from the number of blocks.

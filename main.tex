...
\mnnote{TODO: Éliminer mention de \emph{primary}/\emph{secondary} epoch}
...
\mnnote{TODO: Eliminer mention de \emph{primary}/\emph{secondary} epoch}
...
The use of a consensus protocol to regulate \emph{rename} operations enables systems to discard all parts dedicated to the handling of concurrent \emph{rename} operations, \ie the design of a \emph{priority} relation and the implementation of \Cref{alg:revertRenameId}.

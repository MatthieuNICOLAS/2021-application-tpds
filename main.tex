...
Third, since the main difference between RenamableLogootSplit and consensus protocol-based approaches lies in their respective system model (\ie systems with equal nodes versus systems with privileged nodes), we do not experimentally compare them.
We instead compare them in the form of a discussion in \Cref{sec:core-nebula}.

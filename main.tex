...
\mnnote{TODO: Retravailler contenu de cette sous-section pour prendre en compte les modifications effectuées dans les sections précédentes, améliorer la figure utilisée et développer certains aspects (propriétés de \emph{revertRenameId()}, propriétés du couple \emph{renameId()} - \emph{revertRenameId()}, MàJ de \emph{renameId()} en conséquence)}
